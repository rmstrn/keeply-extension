...
type Callable<C extends EventCallback, R extends MonotypeEventSelector<C> | EventSelector<C>> = {
    /**
...
export type CallableEvent<C extends EventCallback, R extends MonotypeEventSelector<C> | EventSelector<C>> = CoreEvent<C> & Callable<C, R>;
export declare const createEvent: <C extends EventCallback>(selector: EventSelector<C>, validator?: OptionsSelector) => CallableEvent<EventCallback, EventSelector<C>>;
/**
